...
describe("run-mutation", fixture(path.join(__dirname, "fixtures/run-mutation"), [
  async (page) => await page.click("text=Add")
]));

describe("mutation-with-query", fixture(path.join(__dirname, "fixtures/mutation-with-query"), [
  async (page) => await page.click("text=Add"),
  async (page) => await page.click("text=Add")
]));
